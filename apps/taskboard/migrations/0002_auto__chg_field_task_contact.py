...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.contact'
        db.alter_column('taskboard_task', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.UserProfile']))


    def backwards(self, orm):
        
        # Changing field 'Task.contact'
        db.alter_column('taskboard_task', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        'taskboard.task': {
            ...
            'contact': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tasks'", 'to': "orm['users.UserProfile']"}),
