...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('group', 'description', self.gf('django.db.models.fields.TextField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Group.steward'
        db.add_column('group', 'steward', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.UserProfile'], null=True, blank=True), keep_default=False)

        # Adding field 'Group.irc_channel'
        db.add_column('group', 'irc_channel', self.gf('django.db.models.fields.CharField')(default='', max_length=63, blank=True), keep_default=False)

        # Adding field 'Group.website'
        db.add_column('group', 'website', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Group.wiki'
        db.add_column('group', 'wiki', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Group.description'
        db.delete_column('group', 'description')

        # Deleting field 'Group.steward'
        db.delete_column('group', 'steward_id')

        # Deleting field 'Group.irc_channel'
        db.delete_column('group', 'irc_channel')

        # Deleting field 'Group.website'
        db.delete_column('group', 'website')

        # Deleting field 'Group.wiki'
        db.delete_column('group', 'wiki')
