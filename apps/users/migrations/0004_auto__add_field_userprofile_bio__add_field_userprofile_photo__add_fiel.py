...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profile', 'bio', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'UserProfile.photo'
        db.add_column('profile', 'photo', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'UserProfile.display_name'
        db.add_column('profile', 'display_name', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)

        # Adding field 'UserProfile.ircname'
        db.add_column('profile', 'ircname', self.gf('django.db.models.fields.CharField')(default='', max_length=63, blank=True), keep_default=False)

        # display name defaults to firstname lastname
        if not db.dry_run:
            for profile in orm.UserProfile.objects.filter(display_name=''):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('profile', 'bio')

        # Deleting field 'UserProfile.photo'
        db.delete_column('profile', 'photo')

        # Deleting field 'UserProfile.display_name'
        db.delete_column('profile', 'display_name')

        # Deleting field 'UserProfile.ircname'
        db.delete_column('profile', 'ircname')
