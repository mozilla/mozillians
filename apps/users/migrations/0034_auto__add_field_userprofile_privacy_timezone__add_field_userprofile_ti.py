...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.privacy_timezone'
        db.add_column('profile', 'privacy_timezone', self.gf('django.db.models.fields.PositiveIntegerField')(default=3), keep_default=False)

        # Adding field 'UserProfile.timezone'
        db.add_column('profile', 'timezone', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.privacy_timezone'
        db.delete_column('profile', 'privacy_timezone')

        # Deleting field 'UserProfile.timezone'
        db.delete_column('profile', 'timezone')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 18, 7, 26, 5, 112021)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 18, 7, 26, 5, 111950)'}),
        ...
        'users.userprofile': {
            ...
            'privacy_date_mozillian': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3'}),
            ...
            'privacy_timezone': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3'}),
