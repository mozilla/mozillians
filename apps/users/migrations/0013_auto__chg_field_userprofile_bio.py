...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('profile', 'bio', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'UserProfile.bio'
        db.alter_column('profile', 'bio', self.gf('django.db.models.fields.CharField')(max_length=255))
