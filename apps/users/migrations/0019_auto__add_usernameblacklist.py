...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UsernameBlacklist'
        db.create_table('users_usernameblacklist', (
        ...
        db.send_create_signal('users', ['UsernameBlacklist'])


    def backwards(self, orm):
        
        # Deleting model 'UsernameBlacklist'
        db.delete_table('users_usernameblacklist')
