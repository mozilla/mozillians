...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('profile', 'display_name', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.display_name'
        db.alter_column('profile', 'display_name', self.gf('django.db.models.fields.CharField')(max_length=30))
