...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.privacy_date_mozillian'
        db.add_column('profile', 'privacy_date_mozillian', self.gf('django.db.models.fields.PositiveIntegerField')(default=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.privacy_date_mozillian'
        db.delete_column('profile', 'privacy_date_mozillian')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 18, 7, 2, 42, 311664)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 18, 7, 2, 42, 311597)'}),
