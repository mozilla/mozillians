...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('phonebook_invite', 'message')


    def backwards(self, orm):
        # Adding field 'Invite.message'
        db.add_column('phonebook_invite', 'message',
    ...
    models = {
        ...
        'phonebook.invite': {
            ...
            'redeemer': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['users.UserProfile']", 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        'users.userprofile': {
