...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invite.reason'
        db.alter_column(u'phonebook_invite', 'reason', self.gf('django.db.models.fields.TextField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'Invite.reason'
        db.alter_column(u'phonebook_invite', 'reason', self.gf('django.db.models.fields.CharField')(max_length=500))
    ...
    models = {
        ...
        u'phonebook.invite': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inviter': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'invites'", 'null': 'True', 'to': u"orm['users.UserProfile']"}),
            'reason': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '500'}),
            'recipient': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            'redeemed': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'redeemer': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['users.UserProfile']", 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        u'users.userprofile': {
