...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Invite.inviter_old'
        db.delete_column('invite', 'inviter')

        # Deleting field 'Invite.redeemer_old'
        db.delete_column('invite', 'redeemer')


    def backwards(self, orm):
        
        # Adding field 'Invite.inviter_old'
        db.add_column('invite', 'inviter_old', self.gf('django.db.models.fields.CharField')(default='', max_length=32, db_column='inviter'), keep_default=False)

        # Adding field 'Invite.redeemer_old'
        db.add_column('invite', 'redeemer_old', self.gf('django.db.models.fields.CharField')(default='', max_length=32, db_column='redeemer'), keep_default=False)
