...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invite.inviter'
        db.add_column('invite', 'inviter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invites', null=True, to=orm['users.UserProfile']), keep_default=False)

        # Adding field 'Invite.redeemer'
        db.add_column('invite', 'redeemer', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['users.UserProfile'], unique=True, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invite.inviter'
        db.delete_column('invite', 'inviter_id')

        # Deleting field 'Invite.redeemer'
        db.delete_column('invite', 'redeemer_id')
