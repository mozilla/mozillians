...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invite.reason'
        db.add_column(u'phonebook_invite', 'reason',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invite.reason'
        db.delete_column(u'phonebook_invite', 'reason')
    ...
    models = {
        ...
        u'phonebook.invite': {
            ...
            'reason': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '500'}),
