...
OIDC_OP_VERIFICATION_AUTH_ENDPOINT = config('OIDC_OP_VERIFICATION_AUTH_ENDPOINT', default='')
OIDC_OP_VERIFICATION_TOKEN_ENDPOINT = config('OIDC_OP_VERIFICATION_TOKEN_ENDPOINT', default='')
OIDC_OP_VERIFICATION_USER_ENDPOINT = config('OIDC_OP_VERIFICATION_USER_ENDPOINT', default='')
