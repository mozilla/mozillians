...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.new_member_criteria'
        db.add_column('groups_group', 'new_member_criteria',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.new_member_criteria'
        db.delete_column('groups_group', 'new_member_criteria')
    ...
    models = {
        ...
        'groups.group': {
            ...
            'new_member_criteria': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '255'}),
