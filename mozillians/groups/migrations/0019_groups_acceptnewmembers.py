...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Default groups that neither have a curator nor are functional areas to accept new members.
        groups = orm['groups.Group'].objects.filter(curator_id=None, functional_area=False)
        groups.update(accepting_new_members='yes')


    def backwards(self, orm):
        groups = orm['groups.Group'].objects.filter(curator_id=None, functional_area=False)
        groups.update(accepting_new_members='by_request')
