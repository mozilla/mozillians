...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Delete groups.language content type, permissions, etc
        orm['contenttypes.contenttype'].objects.filter(app_label='groups', model='language').delete()
        orm['contenttypes.contenttype'].objects.filter(app_label='groups', model='languagealias').delete()

    def backwards(self, orm):
        # We don't create the content type on backwards. It'll be
