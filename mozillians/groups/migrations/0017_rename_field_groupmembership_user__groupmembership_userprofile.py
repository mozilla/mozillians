...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('groups_groupmembership', ['group_id', 'user_id'])

        db.rename_column('groups_groupmembership', 'user_id', 'userprofile_id')

        # Adding unique constraint on 'GroupMembership', fields ['group', 'userprofile']
        db.create_unique('groups_groupmembership', ['group_id', 'userprofile_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'GroupMembership', fields ['group', 'userprofile']
        db.delete_unique('groups_groupmembership', ['group_id', 'userprofile_id'])

        db.rename_column('groups_groupmembership', 'userprofile_id', 'user_id')

        # Adding unique constraint on 'GroupMembership', fields ['group', 'user']
        db.create_unique('groups_groupmembership', ['group_id', 'user_id'])
