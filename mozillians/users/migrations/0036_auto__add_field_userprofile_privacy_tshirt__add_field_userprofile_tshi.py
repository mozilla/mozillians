...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.privacy_tshirt'
        db.add_column('profile', 'privacy_tshirt',
                      self.gf('mozillians.users.models.PrivacyField')(default=1),
                      keep_default=False)

        # Adding field 'UserProfile.tshirt'
        db.add_column('profile', 'tshirt',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.privacy_tshirt'
        db.delete_column('profile', 'privacy_tshirt')

        # Deleting field 'UserProfile.tshirt'
        db.delete_column('profile', 'tshirt')
    ...
    models = {
        ...
        'users.userprofile': {
            ...
            'tshirt': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
