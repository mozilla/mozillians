...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        for userprofile in orm['users.UserProfile'].objects.all():
            ...
            userprofile.full_name = ' '.join((user.first_name, user.last_name))
            userprofile.full_name = userprofile.full_name.strip()
            user.first_name = ''
            user.last_name = ''
            user.save()
            userprofile.save()
    ...
    def backwards(self, orm):
        for userprofile in orm['users.UserProfile'].objects.all():
            user = userprofile.user
            user.last_name = userprofile.full_name
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 5, 2, 15, 53, 755520)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 5, 2, 15, 53, 755405)'}),
