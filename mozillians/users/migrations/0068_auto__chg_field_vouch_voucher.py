...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vouch.voucher'
        db.alter_column(u'users_vouch', 'voucher_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['users.UserProfile'], null=True))

    def backwards(self, orm):

        # Changing field 'Vouch.voucher'
        db.alter_column(u'users_vouch', 'voucher_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['users.UserProfile']))
