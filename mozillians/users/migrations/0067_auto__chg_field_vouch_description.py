...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vouch.description'
        db.alter_column(u'users_vouch', 'description', self.gf('django.db.models.fields.TextField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'Vouch.description'
        db.alter_column(u'users_vouch', 'description', self.gf('django.db.models.fields.CharField')(max_length=500))
