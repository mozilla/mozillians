...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.privacy_story_link'
        db.add_column('profile', 'privacy_story_link',
                      self.gf('mozillians.users.models.PrivacyField')(default=3),
                      keep_default=False)

        # Adding field 'UserProfile.story_link'
        db.add_column('profile', 'story_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=1024, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.privacy_story_link'
        db.delete_column('profile', 'privacy_story_link')

        # Deleting field 'UserProfile.story_link'
        db.delete_column('profile', 'story_link')
