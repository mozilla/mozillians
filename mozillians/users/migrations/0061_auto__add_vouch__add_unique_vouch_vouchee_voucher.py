...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Vouch'
        db.create_table(u'users_vouch', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('vouchee', self.gf('django.db.models.fields.related.ForeignKey')(related_name='vouches_received', to=orm['users.UserProfile'])),
            ('voucher', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='vouches_made', null=True, blank=True, to=orm['users.UserProfile'])),
        ...
        db.send_create_signal(u'users', ['Vouch'])

        # Adding unique constraint on 'Vouch', fields ['vouchee', 'voucher']
        db.create_unique(u'users_vouch', ['vouchee_id', 'voucher_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Vouch', fields ['vouchee', 'voucher']
        db.delete_unique(u'users_vouch', ['vouchee_id', 'voucher_id'])

        # Deleting model 'Vouch'
        db.delete_table(u'users_vouch')
