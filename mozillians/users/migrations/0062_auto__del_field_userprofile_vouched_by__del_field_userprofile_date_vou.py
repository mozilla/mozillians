...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('profile', 'vouched_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='vouchees', on_delete=models.SET_NULL, default=None, to=orm['users.UserProfile'], blank=True, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.date_vouched'
        db.add_column('profile', 'date_vouched',
