...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'UsernameBlacklist', fields ['value']
        db.create_unique('users_usernameblacklist', ['value'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'UsernameBlacklist', fields ['value']
        db.delete_unique('users_usernameblacklist', ['value'])
    ...
    models = {
        ...
        'users.usernameblacklist': {
            'Meta': {'object_name': 'UsernameBlacklist'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
