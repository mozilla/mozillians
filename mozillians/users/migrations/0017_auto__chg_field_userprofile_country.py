...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('profile', 'country', self.gf('django.db.models.fields.CharField')(max_length=50))


    def backwards(self, orm):

        # Changing field 'UserProfile.country'
        db.alter_column('profile', 'country', self.gf('django.db.models.fields.CharField')(max_length=5))
