...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.referral_source'
        db.add_column('profile', 'referral_source',
                      self.gf('django.db.models.fields.CharField')(default='direct', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.referral_source'
        db.delete_column('profile', 'referral_source')
