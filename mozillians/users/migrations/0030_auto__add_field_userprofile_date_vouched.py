...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.date_vouched'
        db.add_column('profile', 'date_vouched', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.date_vouched'
        db.delete_column('profile', 'date_vouched')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 26, 3, 49, 42, 973707)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 26, 3, 49, 42, 973632)'}),
        ...
        'users.userprofile': {
            ...
            'date_vouched': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
