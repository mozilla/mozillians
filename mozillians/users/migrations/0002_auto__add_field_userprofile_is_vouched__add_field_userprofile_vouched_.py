...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.is_vouched'
        db.add_column('profile', 'is_vouched', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'UserProfile.vouched_by'
        db.add_column('profile', 'vouched_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.UserProfile'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.is_vouched'
        db.delete_column('profile', 'is_vouched')

        # Deleting field 'UserProfile.vouched_by'
        db.delete_column('profile', 'vouched_by_id')
