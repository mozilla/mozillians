...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'APIv2App'
        db.create_table(u'api_apiv2app', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='apps', to=orm['users.UserProfile'])),
            ('key', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=255, blank=True)),
            ('privacy_level', self.gf('mozillians.users.models.PrivacyField')(default=4)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('last_used', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'api', ['APIv2App'])


    def backwards(self, orm):
        # Deleting model 'APIv2App'
        db.delete_table(u'api_apiv2app')
    ...
    models = {
        ...
        u'api.apiv2app': {
            'Meta': {'object_name': 'APIv2App'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "''", 'unique': 'True', 'max_length': '255', 'blank': 'True'}),
            'last_used': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'apps'", 'to': u"orm['users.UserProfile']"}),
            'privacy_level': ('mozillians.users.models.PrivacyField', [], {'default': '4'}),
            'url': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '300', 'blank': 'True'})
        },
        u'auth.group': {
